        ...
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
          ...
          <section className="mb-10">
            ...
            <div className="mt-4 text-sm text-gray-600">
              ...
              <p className="text-justify">If you have any concerns regarding the registration policy or fees please feel free to write us at <a href="mailto:cvs3.congress@gmail.com" className="text-blue-600 hover:underline">cvs3.congress@gmail.com</a> or <a href="mailto:cvs3.congress@gmail.com" className="text-blue-600 hover:underline">cvs3.congress@gmail.com</a>.</p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="mt-4 text-sm text-gray-600">
              ...
              <p className="text-justify">The conference is non-residential and delegates are kindly requested to make their own arrangement for accommodation. If you have any query, please drop a mail to <a href="mailto:cvs3.congress@gmail.com" className="text-blue-600 hover:underline">cvs3.congress@gmail.com</a>. All participants and authors abide by the organization's guidelines.</p>
            </div>
          </section>
        </div>
      </div>
