              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-[#f9f5e9]">
                    ...
                    <th className="border border-gray-300 px-4 py-2 text-left">EARLY REGISTRATION (Before 25th August 2026)</th>
                    <th className="border border-gray-300 px-4 py-2 text-left">LATE REGISTRATION (After 25th August 2026)</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
