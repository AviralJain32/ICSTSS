      ...
      <div className="container mx-auto px-4 py-12 flex-grow">
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
          ...
          <p className="font-graphik text-lg mb-6">
            By submitting papers to ICSTSS 2026, authors are agreeing to the following terms and conditions of the conference.
            ICSTSS 2026 to follow Publication Ethics as laid out and followed by reputed international bodies/societies like COPE, Springer etc.
          </p>
          
          <div className="mb-10">
            <h2 className="font-druk text-2xl text-[#001324] mb-4">DECLARATION BY THE AUTHORS</h2>
            <p className="font-graphik mb-4">
              By submitting papers to ICSTSS 2026, authors are making the following declarations -
            </p>
            <ul className="list-disc pl-6 space-y-2 font-graphik">
              <li>The work that has been submitted to ICSTSS 2026 is the original work carried out by the author(s) of the paper.</li>
              ...
              <li>The paper is currently not under review for publication in any other conference or journal, and it will not be sent to any other conference or journal for consideration while it is under review in ICSTSS 2026.</li>
              ...
              <li>I/we assure ICSTSS 2026 organizers that I/we will follow all the publication ethics of peer-reviewed conference.</li>
              <li>ICSTSS 2026 to follow Publication Ethics as laid out and followed by reputed international bodies/societies like COPE, Springer etc.</li>
            </ul>
          </div>
