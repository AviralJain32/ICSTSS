...
export default function CvAwards() {
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 max-w-2xl">
            <Card className="border border-gray-200 bg-white shadow-sm">
              ...
              <CardContent>
                <p className="text-2xl font-bold text-black">20th August 2026</p>
              </CardContent>
            </Card>
            <Card className="border border-gray-200 bg-white shadow-sm">
              <CardHeader className="pb-3">
              ...
              <CardContent>
                <p className="text-2xl font-bold text-black">30th August 2026</p>
              </CardContent>
            </Card>
          </div>
        </div>
          ...
          <Card className="border border-gray-200 bg-amber-50 shadow-sm">
            ...
            <CardContent className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                ...
                <li>Rationale for its relevance to CV-S3 2026 themes</li>
      ...
      <section className="py-8 bg-amber-50 border-t border-gray-200">
        <div className="container mx-auto px-4 text-center text-gray-600">
          <p>
            <strong>CV-S3 2026</strong> reaffirms its dedication to advancing innovation and collaboration in research
            and technology.
          </p>
        </div>
      </section>
